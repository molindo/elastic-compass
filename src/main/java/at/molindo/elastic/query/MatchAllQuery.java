...
public class MatchAllQuery extends BoostQuery<MatchAllQuery> {

	private MatchAllQueryBuilder _builder;

	public MatchAllQuery() {
		_builder = QueryBuilders.matchAllQuery();
	}
	...
	public MatchAllQuery setNormsField(String normsField) {
		_builder.normsField(normsField);
		return this;
	}
