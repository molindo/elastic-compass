...
public class ElasticMultiResource implements MultiResource, Map<String, Property[]> {
    ...
    public ElasticMultiResource(String alias, ElasticSearchEngineFactory searchEngineFactory) {
        this.alias = alias;
        this.searchEngineFactory = searchEngineFactory;
        currentResource = new ElasticResource(alias, searchEngineFactory);
    ...
    public void copy(Resource resource) {
        ...
        if (resource instanceof MultiResource) {
            ...
            currentResource = (ElasticResource) resource;
