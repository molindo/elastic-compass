...
public class CompassTransactionInterceptor implements Interceptor {
    ...
    private CompassSessionFactory transactionFactory;

    private boolean commitBeforeTransactionCompletion = true;

    private ConcurrentHashMap<Transaction, CompassSession> activeTransactions = new ConcurrentHashMap<Transaction, CompassSession>();
    ...
    public CompassTransactionInterceptor(Compass compass, boolean commitBeforeTransactionCompletion, Interceptor interceptor) {
        ...
        this.transactionFactory = this.compass.getCompassSessionFactory();
    }
    ...
    public void afterTransactionBegin(Transaction transaction) {
        ...
        activeTransactions.put(transaction, session);
    }
    ...
    public void beforeTransactionCompletion(Transaction transaction) {
        ...
        if (activeTransactions.remove(transaction) == null) {
            return;
        }
        CompassSession session = transactionFactory.getTransactionBoundSession();
        session.close();
