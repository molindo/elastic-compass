...
public class CompassConfiguration {
    ...
    public Compass buildCompass() throws CompassException {
        ...
        return new RefreshableCompass(this,new DefaultCompass(copyCompassMapping, converterLookup, copyMetaData, propertyNamingStrategy, executorManager, copySettings));
    }
