...
public class QueryBuilderTests extends AbstractTestCase {
    ...
    @Ignore("SearchEngineMultiPropertyQueryStringBuilder not implemented")
    ...
    @Ignore("SearchEngineMultiPhraseQueryBuilder not implemented")
    ...
    @Ignore("SearchEngineQuerySpanNearBuilder not implemented")
    ...
    @Ignore("SearchEngineQuerySpanOrBuilder not implemented")
